      ...
      return `
        ...
        <div class="details">
          <div class="detail-row">
            ...
            <span class="detail-value">RM ${formatAmount(data.ActualCash)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">System Cash</div>
            <span class="detail-value">RM ${formatAmount(data.Cash)}</span>
          </div>
          <div class="detail-row">
        ...
        <div class="details">
          <div class="detail-row">
            ...
            <span class="detail-value">RM ${formatAmount(data.ActualCard)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">System Bank</div>
            <span class="detail-value">RM ${formatAmount(data.Card)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">Difference</div>
        ...
        <div class="details">
          <div class="detail-row">
            ...
            <span class="detail-value">RM ${formatAmount(data.ActualWallet2)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">System e-Wallet</div>
            <span class="detail-value">RM ${formatAmount(data.Wallet2)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">Difference</div>
            <span class="detail-value ${eWalletDiff.isPositive ? 'difference-positive' : 'difference-negative'}">
              RM ${eWalletDiff.value}
            </span>
          </div>
        </div>
        ...
        <div class="details">
          <div class="detail-row">
            ...
            <span class="detail-value">RM ${formatAmount(data.ActualWallet1)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">System QR</div>
            <span class="detail-value">RM ${formatAmount(data.Wallet1)}</span>
          </div>
          <div class="detail-row">
            <div class="detail-label">Difference</div>
