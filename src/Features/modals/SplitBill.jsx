...
const SplitBill = () => {
  ...
  const handleSplitBill = async () => {
    ...
    try {
      const response = await postRequest(`kot/${cartId}/split-bill/`, {
        details: data,
      });
      ...
      <div className="w-full max-w-5xl h-[90vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="relative p-5 border-b dark:border-gray-700 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <SplitIcon className="w-10 h-10 text-green-600" />
        ...
        <div className="flex flex-grow overflow-hidden">
          ...
          <div className="w-1/3 border-r dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex flex-col">
            ...
            {/* Sales Masters List */}
            <div className="flex-grow p-4 overflow-y-auto hide-scrollbar space-y-3">
              {loading ? (
                ...
                <>
                  ...
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                      {selectedMaster.SkuName}
                    </h2>
                    <div className="flex items-center space-x-2">
                      {/* <span className="text-sm text-gray-600 dark:text-gray-200">
                                            Total: {Currency} {selectedMaster.totalAmount || 0}
                                        </span> */}
                    </div>
                  </div>
