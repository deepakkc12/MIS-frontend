...
const SkuSearchModal = ({ skuList, onFilter, onClear ,fullList}) => {
  ...
  return (
    <div className="fixed  bottom-4 right-4">
      ...
      {isModalOpen && (
        <div ref={modalRef} className="fixed bottom-[5rem] right-4 w-[28rem] bg-white dark:bg-gray-800 shadow-2xl rounded-lg border border-gray-200 dark:border-gray-700 p-4">
