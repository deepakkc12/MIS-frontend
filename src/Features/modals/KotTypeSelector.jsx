...
const KotTypeSelector = () => {
  ...
  const { isOpen } = useSelector((state) => state.newOrderModal);
          ...
          <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none dark:bg-gray-800 focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid rounded-t border-blueGray-200">
              <h3 className="text-3xl font-semibold text-gray-900 dark:text-white">
                Select Kitchen Order Type
              </h3>
              <button
                className="float-right p-1 ml-auto text-3xl font-semibold leading-none text-black bg-transparent border-0 outline-none dark:text-white opacity-5 focus:outline-none"
                onClick={onClose}
              >
