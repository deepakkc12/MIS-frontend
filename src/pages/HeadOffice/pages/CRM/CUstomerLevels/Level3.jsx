...
const Level3Customer = () => {
  ...
  const getData = async () => {
    setLoading(true);
    try {
      const response = await getRequest(`crm/live-customer-list/?level=3`);
      if (response.data) {
  ...
  const Navbar = () => (
    <div className="flex justify-between items-center mb-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Bronze Customer Analytics</h1>
        <p className="text-gray-500">customers contributing to first 50% - 75% of total sales</p>
      </div>
