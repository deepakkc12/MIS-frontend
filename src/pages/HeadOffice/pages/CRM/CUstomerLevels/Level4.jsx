...
const Level4Customer = () => {
  ...
  const getData = async () => {
    setLoading(true);
    try {
      const response = await getRequest(`crm/live-customer-list/?level=4`);
      if (response.data) {
  ...
  const Navbar = () => (
    <div className="flex justify-between items-center mb-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Standard Customer Analytics</h1>
        <p className="text-gray-500">customers contributing to last 25% of total sales</p>
      </div>
